package com.zgamelogic.dataotter.application.database;
...
import com.zgamelogic.dataotter.monitor.database.MonitorConfiguration;
import com.zgamelogic.dataotter.tag.database.Tag;
...
public class Application {
    ...
    public static class ApplicationSerializer extends JsonSerializer<Application> {
        ...
        public void serialize(Application value, JsonGenerator gen, SerializerProvider serializers) throws IOException {
            ...
            for (MonitorConfiguration monitor : value.getMonitors())
                gen.writeNumber(monitor.getId().getMonitorConfigurationId());
            gen.writeEndArray();
    ...
    public static class ApplicationDeserializer extends JsonDeserializer<Application> {
        ...
        @Override
        public Application deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JacksonException {
