...
public interface MonitorStatusRepository extends JpaRepository<MonitorStatus, MonitorStatus.MonitorStatusId> {
    ...
    List<MonitorStatus> findTop2ById_Monitor_Id_MonitorConfigurationIdAndId_Monitor_Id_Application_IdOrderById_DateDesc(Long id_monitor_id_monitorConfigurationId, Long id_monitor_id_application_id);
